	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navresponsive">
			<ul class="navbar-nav  ">
				...
				<li class="nav-item"><a href="bookappoinment.php" class="nav-link ">Update Profile</a><ul class="ulnav">
	...
	if($result)
	{
		while($row=$result->fetch_assoc())
		{
			?><form action="saveappoinment.php" method="post">
			 <tr>
			<td><label>patient name</label></td><td><?php echo $row["fullname"]?></td></tr><tr>
			<td><label>mobile</label></td><td><?php echo $row["mob"]?></td></tr><tr>
			<td><label>Email</label></td><td><?php echo $row["email"]?></td></tr><tr>
			<td><label>booking date&time</label></td><td><?php echo $row["date"]?></td></tr>
			<tr>
			<td><label>booking date&time</label></td><td><?php echo $row["time"]?></td></tr><tr>
		</tr>
