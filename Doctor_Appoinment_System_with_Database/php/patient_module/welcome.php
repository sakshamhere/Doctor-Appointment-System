...
<div class="container-fluid">
	<div class="row">
<div class="col-md-3"><button class="btn btn-outline-secondary btn-lg animated zoomIn" style="animation-delay: 0.5s; background-color: #2B2B52;"><a style="text-decoration: none; color: #F9F3EB; " href="bookappoinment.html" data-toggle="tooltip" title="Wanna book appoinments,click to proceed">Quick Appoinment</a></button></div>

<div class="col-md-3"><button class="btn btn-outline-secondary btn-lg animated zoomIn" style="animation-delay: 1s;background-color:#F9F3EB;"><a style="text-decoration: none;color:#2B2B52; " href="canselappoinment.php" data-toggle="tooltip" title="Wanna Cansel your bookin??!!">Cansel Appoinment</a></button></div>
...
<div class="col-md-3" ><button class="btn btn-outline-secondary btn-lg animated zoomIn" style="animation-delay: 2s;background-color:#F9F3EB;"><a style="text-decoration: none;color:#2B2B52 " href="#" data-toggle="tooltip" title="Wanna know more about your doctor,click to proceed">Myprofile</a></button></div>
</div>
</div>
<br>
<hr class="light">
