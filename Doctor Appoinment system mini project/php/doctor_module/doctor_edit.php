	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navresponsive">
			<ul class="navbar-nav  ">
				...
				<li class="nav-item"><a href="bookappoinment.php" class="nav-link ">Update Profile</a>
	...
	if($result)
	{
		while($row=$result->fetch_assoc())
		{
			?><form action="doctor_update.php" method="post">
			 <tr>
			<td><label>Name</label></td><td><input type="text" name="name" value="<?php echo $row["name"]?>"></td></tr><tr>
			<td><label>Mobile</label></td><td><input type="text" name="mob" value="<?php echo $row["mob"]?>"></td></tr><tr>
			<td><label>Email</label></td><td><input type="text" name="mail" value="<?php echo $row["mail"]?>"></td></tr><tr>
			<td><label>DOB</label></td><td><input type="text" name="dob" value="<?php echo $row["dob"]?>"></td></tr>
			<tr>
			<td><label>Address</label></td><td><input type="text" name="address" value="<?php echo $row["address"]?>"></td></tr><tr>
				<tr>
			<td><label>city</label></td><td><input type="text" name="city" value="<?php echo $row["city"]?>"></td></tr><tr>
			<tr>
			<td><label>Designation</label></td><td><input type="text" name="designation" value="<?php echo $row["designation"]?>"></td></tr><tr>	
		</tr>
