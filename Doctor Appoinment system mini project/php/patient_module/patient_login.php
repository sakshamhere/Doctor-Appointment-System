...
{
  header('location:patient_module/welcome.php');
}
else{
?>
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navresponsive">
			<ul class="navbar-nav  ">
				...
				<li class="nav-item"><a href="../../static/patient_register.html" class="nav-link ">sign up</a><ul class="ulnav">
				<!-- 	<li><a href="../static/patient_register.html">drop down</a></li> -->
...
<!-- login div -->
<br>
<form action="patient_logincheck.php" method="post">
<div class="loginbox">
