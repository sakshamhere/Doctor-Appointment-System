...
<nav class="navbar navbar-dark navbar-expand-sm bg-dark ">
	<a href="../patient_module/welcome.php" class="navbar-brand mr-auto ml-auto">Dashboard</a>
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navresponsive">
			<ul class="navbar-nav  ">
				...
				<li class="nav-item"><a href="../patient_module/bookappoinment.php" class="nav-link ">Book appoinment</a><ul class="ulnav">
					<!-- <li><a href="registeration.html">AS a Patient</a></li>
					<li><a href="registeration2.html">As a Doctor</a></li> -->
				</ul></li>
				<li class="nav-item"><a href="../patient_module/myappoinment.php" class="nav-link" ">My appoinments</a></li>
				<li class="nav-item"><a href="../patient_module/canselappoinment.php" class="nav-link">Cancel Appoinment</a></li>
				...
				<li class="nav-item"><a href="../patient_module/destroy_session.php" class="nav-link"><span class="spancolor">log out</span></a></li>
...
if($result)
{
	while($row=$result->fetch_assoc() )
	{
      ...
      <div class="card animated fadeIn" style="animation-delay:1s">
      	<div class="card-header name"><?php echo $row["name"]?></div>
      	...
      	<div class="card-footer" style="float: left;">
      		<form action="../patient_module/doctors_availible_details.php" method="post">
