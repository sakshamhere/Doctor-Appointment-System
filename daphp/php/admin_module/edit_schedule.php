...
if(isset($_POST['edit']))
{
	...
	$sql1 ="select * from appoinment_schedule where doctor_name='$dname";
    
    $sql2 ="select * from payment_schedule where doctor_name='$dname";
    ...
    {    
      ?>  <form action="saveappoinment.php" method="post"><tr>
			<td><label>patient name</label></td><td><input type="text" name="fname" value=<?php echo $row1["doctor_name"]?>></td></tr>
			<tr>
			<td><label>end date</label></td><td><input type="text" name="date" value="<?php echo $row1["end_time"]?>"></td></tr>
			<tr>
			<td><label>Email</label></td><td><input type="text" name="email" value="<?php echo $row1["start_time"]?>"></td></tr>
	<?php		
    }
    ...
    { 
			...
			?>
				<input type="hidden" name="id" value=<?php echo $row["doctor_name"];?>>
			<tr>
			<td><label>mobile</label></td><td><input type="text" name="mob" value="<?php echo $row2["fees"]?>"></td></tr>
			<tr>
