...
<div class="container-fluid">
	...
	<div class=" col-lg-6 " style="background-color: #4C4B4B;color: #74B9FF;" >
		...
		<td><input type="text" class="tableinput"  name="name"  id="name" placeholder="Name"></td>
	</tr>
	<tr>
		<td><label>Mail id</label></td>
		<td><input class="tableinput" type="email"   name="mail" id="mail" placeholder="E-Mail"></td>
	</tr>
	<tr>
		<td><label>Mob</label></td>
		<td><input type="number" class="tableinput"  name="mob" id="mob" placeholder="Mobile no"></td>
	</tr>
	<tr>
		<td><label>dob</label></td>
		<td><input type="date"  class="tableinput" name="dob" id="dob" placeholder="dd/mm/yy"></td>
	</tr>
	<tr>
		<td><label>Address</label></td>
		<td><input type="textarea"  class="tableinput" name="address" id="address" placeholder="address"></td>
	</tr>
	<tr>
		<td><label>City</label></td>
		<td><input type="text"  class="tableinput" name="city" id="city" placeholder="city"></td>
	</tr>
	<tr>
		<td><label>Designation</label></td>
		<td><input type="text"  class="tableinput" name="Designation" id="designation" placeholder="Designation"></td>
	</tr>

	<tr>
		<td><label>password</label></td>
		<td><input type="password" class="tableinput"  name="password" id="password" placeholder="password"></td>
	</tr>
	<tr>
		<td><label>confirm password</label></td>
		<td><input type="password"  class="tableinput" name="confirmpass" id="conpassword" placeholder="confirm"></td>
	</tr>
	<tr>
		<td><label>upload profile photo</label></td>
		<td><input type="file" id="fileupload" class="tableinput" name="fileupload" id="fileupload" ></td>
	</tr>
	<tr>
		
		<td colspan="2"><input class="btn btn-outline-secondary btn-lg button " type="submit" name="btn" value="submit" onclick="return validate()"></td>
	</tr>
	<tr>
	...
	<br><br><br>
		<h4 id="warning" class="warning animated flash" style="color: #74B9FF; animation-iteration-count: infinite;animation-delay: 1s;"></h4>

        <table>
        	<tr>
        		<td><label style="color: #fff;">Doctor fee</label></td><td><input type="text" class="tableinput" name="fee" id="name"></td>
        	</tr>
        	<tr>
        		<td><label style="color: #fff;">Availible from</label></td><td><input type="time" name="start" class="tableinput"></td>
        		
        	</tr>
        	<tr>
        		<td><label style="color: #fff;">To</label></td><td><input class="tableinput" type="time" name="end"></td>
        	</tr>
        	<tr><a class="btn btn-outline-primary " href="add_calender.php">Add calender</a></tr>
        </table>
